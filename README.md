...
After determining a candidate application for modernization to WebSphere Liberty, you use the accelerators generated by TA to deploy the application to WebSphere Liberty on your local developer machine to validate the solution.
