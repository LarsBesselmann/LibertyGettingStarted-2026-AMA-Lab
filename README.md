...
11. Upload the AMA license to get a full migration plan.
    ...
    /tmp/post_deploy_repo/scripts/AMA_46x_applyLicenseKey.sh

    <kbd>![AMA_Evaluation_Assessment-modresorts14.png](./images/media/AMA_Evaluation_Assessment-modresorts14.png)</kbd>

12. Switch back to the AMA UI and reload the page

    <kbd>![AMA_Evaluation_Assessment-modresorts15.png](./images/media/AMA_Evaluation_Assessment-modresorts15.png)</kbd>

    You should see that the trial information has been removed.

    <kbd>![AMA_Evaluation_Assessment-modresorts16.png](./images/media/AMA_Evaluation_Assessment-modresorts16.png)</kbd>

13. Click again to download the **Migration Plan** generated by AMA.

    <kbd>![AMA_Evaluation_Assessment-modresorts11.png](./images/media/AMA_Evaluation_Assessment-modresorts11.png)</kbd>

    The migration plan will be downloaded to the Downloads folder
    <kbd>![AMA_Evaluation_Assessment-modresorts17.png](./images/media/AMA_Evaluation_Assessment-modresorts17.png)</kbd>

14.	Switch to the terminal window and execute the following command to see the content of the migration bundle. 
