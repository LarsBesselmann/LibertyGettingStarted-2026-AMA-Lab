...
1. Access the AMA UI and create a workspace called **Evaluation**.
    1. Open a browser window by clicking on **Activities** and then select the **Firefox** browser icon.
...
Now, let’s simulate the steps to run the data collector.
    ...
    Go back to the Terminal window and navigate the /home/techzone/Downloads directory and view its contents with commands:
